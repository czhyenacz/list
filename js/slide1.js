...
function f1fffffffffffff(){
    ...
    ll1llllllllllll.style.position="relative";
...
function f1ff(){
    ...
    if(llllllll==1){
        if(!((ReachedTheEnd==1)&&(1==0))){
            ...
            if(ll1lllllll==0){
                ll1ll=setTimeout('slide1.f1ffff()',(ekbekleme+4000));
            }
        }
    }else{
    ll1ll=setTimeout("slide1.ff1ffff()",4000);
}
}
}
function f1fff(){
    ...
    if(op>(0.00)){
        ll1ll=setTimeout('slide1.f1fff()',50);
    }else{
...
function f1fffffffffffffff(){
    ...
    if(lllll<=0){
        ...
        ll1ll=setTimeout("slide1."+trans_func_str+"()",50);
    }
}
...
if(llllllll==1){
    if(!((ReachedTheEnd==1)&&(1==0))){
        ...
        if(ll1lllllll==0){
            ll1ll=setTimeout('slide1.'+fname+'()',4000);
        }
    }
}else{
    ll1ll=setTimeout('slide1.ff1ffff()',4000);
...
if(llllllll==1){
    if(!((ReachedTheEnd==1)&&(1==0))){
        if(tam==0){
            if(ll1lllllll==0){
                devam("f1fffffffffffffff",50);
            }
        }else{
        if(ll1lllllll==0){
            ll1ll=setTimeout("slide1."+"f1fffffffffffffff"+"()",50);
        }
    }
}else{
    ll1ll=setTimeout('slide1.ff1ffff()',50);
}
}
}
function Sonraki(){
...
function devam(fm,pt){
    if((imgarr[lll].c==1)&&(imgarr[ll].c==1)){
        ll1ll=setTimeout('slide1.'+fm+'()',pt);
    }else{
        ll1ll=setTimeout('slide1.devam("'+fm+'",'+pt+')',4000);
    }
    var cagain=1;
...
function ff1fffff(msec){
    if(tam==0){
        ...
        if(2==0){
            ll1ll=setTimeout("slide1.DoJustSwitch()",msec);
        }else if(2==1){
            ll1ll=setTimeout("slide1.f1ffff()",msec);
        }else{
            ll1ll=setTimeout("slide1.f1fffffffffffffff()",msec);
        }
    }
}
function ff1ffffff(){
    ...
    for(i=0;i<3;i++){
        lllllllllllll[i]=document.getElementById("slide1d"+i);
    }
    if(0==1){
        f1fffffffffffff();
    }
    ...
    if(3>1){
        ...
        fffffffffffff();
        if(2==0){}else if(2==1){        } else if(2==2)        {
            lllll=icwidth;
            lllllllllllll[lll].style.left=""+lllll+"px";
            zindx();
        }else if(2==3){
...
function ff1fffffff(){
    ...
    dstr1='<div id="';
    dstr2='" style="position:absolute;visibility:hidden;top:0px;padding:0px;margin:0px;overflow:hidden;">';
    dstr23='<table cellspacing="0" cellpadding="0" style="position:relative;ltop:0px;padding:0px;margin:0px;"><tr><td style="width:'+icwidth+'px;height:'+icheight+'px;top:0px;padding:0px;margin:0px;text-align:'+'center'+';vertical-align:'+'middle'+';">';
    dstr3='<img id="img';
    dstr4='" src="';
    dstr5='"  border="0" style="position:relative;'+'top:0px;'+'border-style:'+'solid'+';border-width:'+'0'+'px;border-color:'+'#CCCCCC'+';'+""+'" alt=""></img>';
    dstr56='</td></tr></table>';
    dstr6='</div>';
    i=0;
    innertxt="";
...
function Bas(){
    DisObj=document.getElementById('slide1sodis');
    if(!DisObj){
        setTimeout('slide1.Bas()',200);
        return;
    }
    ff1fffffff();
}
...
imgarr[0].src=slide1foldername+'1.png';
imgstr[0]=slide1foldername+'1.png';
thumbimgstr[0]=slide1foldername+'1.png';
linkstr[0]='';
targetstr[0]="";
titarr[0]="";
desarr[0]="";
...
imgarr[1].src=slide1foldername+'2.png';
imgstr[1]=slide1foldername+'2.png';
thumbimgstr[1]=slide1foldername+'2.png';
linkstr[1]='';
targetstr[1]="";
titarr[1]="";
desarr[1]="";
...
imgarr[2].src=slide1foldername+'3.png';
imgstr[2]=slide1foldername+'3.png';
thumbimgstr[2]=slide1foldername+'3.png';
linkstr[2]='';
targetstr[2]="";
titarr[2]="";
desarr[2]="";
...
var icwidth=600-2*(1);
var icheight=150-2*(1);
var bgd=0;
var trans_func_str="f1fffffffffffffff";
if(thumbgoster==1){
