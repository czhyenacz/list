...
function f1ff(){
    ...
    if(llllllll==1){
        if(!((ReachedTheEnd==1)&&(1==0))){
            ...
            if(ll1lllllll==0){
                ll1ll=setTimeout('slide2.f1ffff()',(ekbekleme+4000));
            }
        }
    }else{
    ll1ll=setTimeout("slide2.ff1ffff()",4000);
}
}
}
function f1fff(){
    ...
    if(op>(0.00)){
        ll1ll=setTimeout('slide2.f1fff()',50);
    }else{
...
function f1fffffffffffffff(){
    ...
    if(lllll<=0){
        ...
        ll1ll=setTimeout("slide2."+trans_func_str+"()",50);
    }
}
...
if(llllllll==1){
    if(!((ReachedTheEnd==1)&&(1==0))){
        ...
        if(ll1lllllll==0){
            ll1ll=setTimeout('slide2.'+fname+'()',4000);
        }
    }
}else{
    ll1ll=setTimeout('slide2.ff1ffff()',4000);
...
if(llllllll==1){
    if(!((ReachedTheEnd==1)&&(1==0))){
        ...
        if(ll1lllllll==0){
            ll1ll=setTimeout("slide2."+"f1fffffffffffffff"+"()",50);
        }
    }
}else{
    ll1ll=setTimeout('slide2.ff1ffff()',50);
}
}
}
function Sonraki(){
...
function devam(fm,pt){
    if((imgarr[lll].c==1)&&(imgarr[ll].c==1)){
        ll1ll=setTimeout('slide2.'+fm+'()',pt);
    }else{
        ll1ll=setTimeout('slide2.devam("'+fm+'",'+pt+')',4000);
    }
    var cagain=1;
...
function ff1fffff(msec){
    if(tam==0){
        ...
        if(2==0){
            ll1ll=setTimeout("slide2.DoJustSwitch()",msec);
        }else if(2==1){
            ll1ll=setTimeout("slide2.f1ffff()",msec);
        }else{
            ll1ll=setTimeout("slide2.f1fffffffffffffff()",msec);
        }
    }
}
function ff1ffffff(){
    ...
    for(i=0;i<3;i++){
        lllllllllllll[i]=document.getElementById("slide2d"+i);
    }
    if(0==1){
        f1fffffffffffff();
    }
...
function ff1fffffff(){
    ...
    for(i=0;i<3;i++){
        ...
        innertxt=innertxt+dstr1+"slide2d"+i+dstr2+dstr23+lnkstr+dstr3+i+dstr4+imgstr[i]+dstr5+lnkstrclose+dstr56+dstr6;
    }
    spageIcObj.innerHTML=""+innertxt;
    setTimeout('slide2.ff1ffffff()',100);
}
function Bas(){
    DisObj=document.getElementById('slide2sodis');
    if(!DisObj){
        setTimeout('slide2.Bas()',200);
        return;
    }
    ff1fffffff();
}
...
imgarr[0].src=slide2foldername+'1.png';
imgstr[0]=slide2foldername+'1.png';
thumbimgstr[0]=slide2foldername+'1.png';
linkstr[0]='';
targetstr[0]="";
titarr[0]="";
desarr[0]="";
...
imgarr[1].src=slide2foldername+'2.png';
imgstr[1]=slide2foldername+'2.png';
thumbimgstr[1]=slide2foldername+'2.png';
linkstr[1]='';
targetstr[1]="";
titarr[1]="";
desarr[1]="";
...
imgarr[2].src=slide2foldername+'3.png';
imgstr[2]=slide2foldername+'3.png';
thumbimgstr[2]=slide2foldername+'3.png';
linkstr[2]='';
targetstr[2]="";
titarr[2]="";
desarr[2]="";
...
document.write("<div id=\"slide2sodis\"></div>");
