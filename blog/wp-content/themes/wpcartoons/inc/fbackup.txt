		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/wpcartoons/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/category/medicine/' target='_blank'>Free WordPress medicine themes</a>, thanks to: <a href='http://wpdis.co/' target='_blank'>Free auto WordPress themes</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/fit-fitnessgym-responsive-wordpress-theme/' target='_blank'>WordPress theme</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
