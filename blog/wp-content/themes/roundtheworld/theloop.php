...
<h2><?php the_title(); ?></h2>
			<?php } ?>
			<p><?php if (!is_page()) {?><?php echo get_the_date(); ?> <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/category.png"><?php the_category(',&nbsp;'); }?>
			<?php if(comments_open( get_the_ID() ))  {
                    ?><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/comments.png">&nbsp;<span class="meta_comments"><?php comments_popup_link( $SMTheme->_( 'noresponses' ), $SMTheme->_( 'oneresponse' ), $SMTheme->_( 'multiresponse' ) ); ?></span><?php
                }
