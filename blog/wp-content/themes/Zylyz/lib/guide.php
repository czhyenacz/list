...
?>
<div class="wrap">
<div class="opwrap" style="background:#fff; margin:20px 0; width:860px; padding:20px; border:1px solid #ddd;" >
...
<div class="gblock">
  ...
  <h2>How to add recipe posts?</h2>
  <p> Checkout the screencast below to see in action how to create recipe posts </p>
  <p><iframe src="http://www.screenr.com/embed/vfCs" width="650" height="396" frameborder="0"></iframe></p>
 
   <h2>Zylyz Theme Options</h2>
  <p> Checkout the screencast below to see in action of different theme options </p>
  <p><iframe src="http://www.screenr.com/embed/afCs" width="650" height="396" frameborder="0"></iframe></p>
