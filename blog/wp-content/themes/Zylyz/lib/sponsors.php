...
<li>
<?php 
	$ban1 = get_option('zyl_banner1'); 
	$url1 = get_option('zyl_url1'); 
	$lab1 = get_option('zyl_lab1'); 
	$alt1 = get_option('zyl_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('zyl_banner2'); 
	$url2 = get_option('zyl_url2'); 
	$lab2 = get_option('zyl_lab2'); 	
	$alt2 = get_option('zyl_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('zyl_banner3'); 
	$url3 = get_option('zyl_url3'); 
	$lab3 = get_option('zyl_lab3'); 
	$alt3 = get_option('zyl_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('zyl_banner4'); 
	$url4 = get_option('zyl_url4');
	$lab4 = get_option('zyl_lab4'); 
	$alt4 = get_option('zyl_alt4');	
?>
