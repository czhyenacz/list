...
$options = array (
	...
	array("name" => "Home page content",
			"desc" => "Select between recipes or posts to display on homepage",
			"id" => $shortname."_home",
            "type" => "select",		
			"options" => array('Recipes', 'Posts'),		
   		    "std" => ""),
	...
	array(   "name" => "Slider content",
     		 ...
     		 "type" => "select",		
			 "options" => array('recipes', 'post'),		
   		     "std" => ""),	   
		   
	
	array( 	"name" => "Slider Category",
			"desc" => "Select the category for the slider items.",
...
?>
<div class="wrap">
<div class="opwrap" style="background:#fff; margin:20px 0px; width:860px; padding:20px; border:1px solid #ddd;" >
