    ...
    $settings = array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'106','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
					'type'=>'text','name'=>'imgheight','value'=>'106','ttl'=>'Loop image height', 'hint'=>'Featured images height (px)'
				),
				'imgpos'=>array(
