		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/fruitiness/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/yummyblog/' target='_blank'>Restaurant WordPress theme</a>, thanks to: <a href='http://wpdis.co/free/spapress/' target='_blank'>Free medicine WordPress themes</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/fit-fitnessgym-responsive-wordpress-theme/' target='_blank'>Best WordPress theme</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
